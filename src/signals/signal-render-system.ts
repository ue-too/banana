...
export class SignalRenderSystem {
    ...
    private _textures: Record<'red' | 'yellow' | 'green', Texture> | null =
        null;

    /** Active sprites keyed by signal ID. */
    private _sprites: Map<
        SignalId,
        { sprite: Sprite; container: Container; currentAspect: string }
    > = new Map();
