...
type SubStateMachine = TemplateStateMachine<
    SubEventMapping,
    SubContext,
    SubStatesWithinMain,
...
class SubStartState extends TemplateState<
    SubEventMapping,
    SubContext,
    SubStatesWithinMain,
    SubEventOutputMapping
...
class SubEndState extends TemplateState<
    SubEventMapping,
    SubContext,
    SubStatesWithinMain,
    SubEventOutputMapping
...
class MainIdleState extends TemplateState<
    MainEventMapping,
    MainContext,
    MainStates
> {
...
class MainCurveCreationState extends TemplateState<
    MainEventMapping,
    MainContext,
    MainStates
> {
...
class MainPlacementState extends TemplateState<
    MainEventMapping,
    MainContext,
    MainStates
> {
...
class MainIdleExtensionState extends TemplateState<
...
> {
    ...
    constructor() {
        ...
        this._guards =
            originalIdleState.guards as unknown as Guard<MainContext>;
    ...
    > = {
        action: (context, event, eventKey, stateMachine) => {
            ...
            const result = (
                this._subStateMachine.happens as (
                    k: keyof SubEventMapping,
                    p: SubEventMapping[keyof SubEventMapping]
                ) => ReturnType<SubStateMachine['happens']>
            )(key, payload);
...
const expandState = createAdaptedStateToExpansionFunc<
    State<MainEventMapping, MainContext, MainStates>,
    State<
        MainEventMappingExtension,
        MainContext,
        MainStates,
