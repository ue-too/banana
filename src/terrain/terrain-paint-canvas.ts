...
export const GROUND_PALETTE_INDEX: number = TERRAIN_PALETTE.findIndex(
    p => p.height === 0
);
...
export class TerrainPaintCanvas {
    ...
    constructor(width: number, height: number) {
        ...
        this._terrainImageData = this._terrainCtx.createImageData(
            width,
            height
        );
